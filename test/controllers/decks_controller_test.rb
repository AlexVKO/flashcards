...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { category_id: @deck.category_id, description: @deck.description, name: @deck.name } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { category_id: @deck.category_id, description: @deck.description, name: @deck.name } }
